...
该格式基于 [Keep a Changelog](https://keepachangelog.com/en/1.0.0/)，并遵循 [语义版本控制](https://semver.org/spec/v2.0.0.html)。

### [0.36.0] - 2024-11-07
#### ✨ 亮点

- 现在可以使用 `pixi upgrade` 升级项目依赖。
- 对前缀验证检查进行了性能改进，提升了 `pixi run` 启动速度。

#### 新增

- 在 trampoline 中添加 powerpc64le 目标，由 @ruben-arts 在 [#2419](https://github.com/prefix-dev/pixi/pull/2419) 提交
- 再次添加 trampoline 测试，由 @Hofer-Julian 在 [#2420](https://github.com/prefix-dev/pixi/pull/2420) 提交
- 添加 `pixi upgrade`，由 @Hofer-Julian 在 [#2368](https://github.com/prefix-dev/pixi/pull/2368) 提交
- 添加 win-64 作为 win-arm64 的平台回退，由 @chawyehsu 在 [#2427](https://github.com/prefix-dev/pixi/pull/2427) 提交
- 为 `pixi project channel add` 添加 `--prepend` 选项，由 @mrswastik-robot 在 [#2447](https://github.com/prefix-dev/pixi/pull/2447) 提交

#### 文档更新

- 修复了 CLI 基本用法示例，由 @lucascolley 在 [#2432](https://github.com/prefix-dev/pixi/pull/2432) 提交
- 更新 Python 教程，由 @LiamConnors 在 [#2452](https://github.com/prefix-dev/pixi/pull/2452) 提交
- 改进了 `pixi global` 文档，由 @Hofer-Julian 在 [#2437](https://github.com/prefix-dev/pixi/pull/2437) 提交

#### 修复

- 使用 `--silent` 替代 `--no-progress-meter` 以支持旧版 `curl`，由 @jaimergp 在 [#2428](https://github.com/prefix-dev/pixi/pull/2428) 提交
- 搜索应返回所有平台的最新包，由 @nichmor 在 [#2424](https://github.com/prefix-dev/pixi/pull/2424) 提交
- 修复 trampoline 解包问题，由 @ruben-arts 在 [#2422](https://github.com/prefix-dev/pixi/pull/2422) 提交
- 修复 PyPI 索引问题（v0.35.0 回归），由 @tdejager 在 [#2465](https://github.com/prefix-dev/pixi/pull/2465) 提交
- 修复 PyPI git 依赖问题（v0.35.0 回归），由 @wolfv 在 [#2438](https://github.com/prefix-dev/pixi/pull/2438) 提交
- 容忍 pixi 文件错误（v0.35.0 回归），由 @jvenant 在 [#2457](https://github.com/prefix-dev/pixi/pull/2457) 提交
- 确保任务根据最佳平台进行获取，由 @jjjermiah 在 [#2446](https://github.com/prefix-dev/pixi/pull/2446) 提交

#### 性能改进

- 快速前缀验证检查，由 @ruben-arts 在 [#2400](https://github.com/prefix-dev/pixi/pull/2400) 提交

#### 新贡献者
* @jvenant 在 [#2457](https://github.com/prefix-dev/pixi/pull/2457) 提交了首次贡献
* @mrswastik-robot 在 [#2447](https://github.com/prefix-dev/pixi/pull/2447) 提交了首次贡献
* @LiamConnors 在 [#2452](https://github.com/prefix-dev/pixi/pull/2452) 提交了首次贡献
